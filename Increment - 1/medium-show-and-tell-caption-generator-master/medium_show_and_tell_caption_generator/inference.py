...
tf.flags.DEFINE_string("model_path", "E:/t6/Tutorial 6 Source Code/medium-show-and-tell-caption-generator-master/model/show-and-tell.pb", "Model graph def path")
tf.flags.DEFINE_string("vocab_file", "E:/t6/Tutorial 6 Source Code/medium-show-and-tell-caption-generator-master/etc/word_counts.txt", "Text file containing the vocabulary.")
tf.flags.DEFINE_string("input_files", "C:/Users/Sireesha Keesara/Downloads/Flickr8k/Flickr8k/Flickr8k_Dataset/Flicker8k_Dataset/*.jpg",
