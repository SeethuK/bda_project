...
public class Main {
    public static void main(String args[]) throws IOException {
        ...
        //Reading a file
        File captions = new File("C:\\Users\\Sireesha Keesara\\Downloads\\Flickr8k\\Flickr8k\\Flickr8k_text\\Flickr8k.token.txt");
                    ...
                    if (keywordmap.containsKey(lemma)) {
                        ...
                        if(lemma.equals("baseball")){
                            ...
                            if (matcher.find()){
                                ...
                                Path temp = Files.copy(Paths.get("C:\\Users\\Sireesha Keesara\\Downloads\\Flickr8k\\Flickr8k\\Flickr8k_Dataset\\Flicker8k_Dataset" + matcher.group(0)), Paths.get("C:\\Users\\Sireesha Keesara\\Downloads\\Flickr8k\\Data\\baseball" + matcher.group(0)), REPLACE_EXISTING);
                            }
                        }
                        if(lemma.equals("football")){
                            ...
                            if (matcher.find()){
                                ...
                                Path temp = Files.copy(Paths.get("C:\\Users\\Sireesha Keesara\\Downloads\\Flickr8k\\Flickr8k\\Flickr8k_Dataset\\Flicker8k_Dataset"+ matcher.group(0)), Paths.get("C:\\Users\\Sireesha Keesara\\Downloads\\Flickr8k\\Data\\football" + matcher.group(0)), REPLACE_EXISTING);
                        ...
                        if(lemma.equals("basketball")){
                            ...
                            if (matcher.find()){
                                ...
                                Path temp = Files.copy(Paths.get("C:\\Users\\Sireesha Keesara\\Downloads\\Flickr8k\\Flickr8k\\Flickr8k_Dataset\\Flicker8k_Dataset" + matcher.group(0)), Paths.get("C:\\Users\\Sireesha Keesara\\Downloads\\Flickr8k\\Data\\basketball" + matcher.group(0)), REPLACE_EXISTING);
