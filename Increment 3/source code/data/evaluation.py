...
filename = 'data/train_file_name.txt'
...
# load test set
filename = 'data/test_file_name.txt'
...
# photo features
test_features = load_photo_features('C:/Users/Sireesha Keesara/PycharmProjects/lab4/models/features.pkl', test)
print('Photos: test=%d' % len(test_features))

# load the model
filename = 'C:/Users/Sireesha Keesara/PycharmProjects/lab4/data/model_2.h5'
